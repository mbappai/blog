...
You can already see a bacon pie in one of the production slots with the time it will take to finish baking it with a _mysterious button_ beside it
...
User starts to watch ads. Notice the text below the playback area that reads _Reward in 4 seconds_ to affirm to you that they'll deliver
on their promise
...
As long as you're able to find a way of rewarding users on your platform, you can get them to do anything you want, _willingly ofcourse_
